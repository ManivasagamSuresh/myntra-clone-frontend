  ...
  return (
    ...
    <div className='container addproduct'>
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <input className={`form-control addproduct-inputs ${formik.touched.brand && formik.errors.brand ? 'error-box':""}
        ...
        <input className={`form-control addproduct-inputs ${formik.touched.description && formik.errors.description ? 'error-box':""}
        ...
        onBlur={formik.handleBlur}
        />
        <input className={`form-control addproduct-inputs ${formik.touched.img && formik.errors.img ? 'error-box':""}
        ...
        />
          ...
          <select className='form-control addproduct-inputs'
          name='category' 
          onChange={formik.handleChange} 
