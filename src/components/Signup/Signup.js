...
function Signup() {
  ...
  return (
    ...
    <div className='signup-C'>
        ...
        <input className={`signup-inputs form-control ${formik.touched.name && formik.errors.name ? 'error-box':""}
        ...
        `} 
          ...
          {
            formik.touched.name && formik.errors.name ? <span className='error-span'>{formik.errors.name}</span> : null
          }


          <input className={`signup-inputs form-control ${formik.touched.email && formik.errors.email ? 'error-box':""}
        ${formik.touched.email && !formik.errors.email ? 'success-box':""}`} 
          ...
          <input className={`signup-inputs form-control ${formik.touched.password && formik.errors.password ? 'error-box':""}
        ${formik.touched.password && !formik.errors.password ? 'success-box':""}`} 
          ...
          <input className={`signup-inputs form-control ${formik.touched.confirmpassword && formik.errors.confirmpassword ? 'error-box':""}
        ${formik.touched.confirmpassword && !formik.errors.confirmpassword ? 'success-box':""}`} 
          ...
          {
            formik.touched.confirmpassword && formik.errors.confirmpassword ? <span className='error-span'>{formik.errors.confirmpassword}</span> : null
          }

        
          <textarea className={`signup-inputs form-control ${formik.touched.address && formik.errors.address ? 'error-box':""}
        ${formik.touched.address && !formik.errors.address ? 'success-box':""}`} 
          ...
          {
            formik.touched.address && formik.errors.address ? <span className='error-span'>{formik.errors.address}</span> : null
          }

          <input className={`signup-inputs form-control ${formik.touched.phone && formik.errors.phone ? 'error-box':""}
        ${formik.touched.phone && !formik.errors.phone ? 'success-box':""}`} 
          ...
          <div className='signup-terms'>By continuing ,I agree to the 
          <span className='signup-terms1'>Terms of Use</span> & 
          <span className='signup-terms1'>Privacy Policy</span></div>
