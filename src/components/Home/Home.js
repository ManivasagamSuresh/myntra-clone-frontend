   ...
   <div className='container home'>
    <div className='row'>
        <div className='col-lg-12'>
          <img src={myntrahome} className="myntrahomeimg" onClick={()=>{navigate("/products")}}/>
        </div>
        </div>
        <div className='row'>
          <Homecard/>
        ...
        <div className='col-lg-12 home-budgetinfo'>
          ...
          <div className='col-lg-6  home-shop' onClick={()=>{navigate("/filter/genderprice/Men")}}>
            <img src={men} className="home-budgetimg"/>
            <div style={{marginTop:"20px"}}>SHOP MEN</div>
            </div>
          <div className='col-lg-6 home-shop' onClick={()=>{navigate("/filter/genderprice/Women")}}>
